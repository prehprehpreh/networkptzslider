...
PARAMS_FILE = r"C:\Users\prehp\Downloads\motor_params.json"
...
def receive_udp_messages():
    ...
    params = load_params_from_json()  # Load params once for consistency
    while True:
        try:
            ...
            if "CURRENT_POS:" in message:
                ...
                if params:
                    ...
                    time.sleep(0.1)  # Delay to ensure Arduino processes the message
