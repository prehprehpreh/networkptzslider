...
# UDP Configuration
UDP_IP = "192.168.1.78"  # Arduino's IP Address
...
invert_left = False  # Toggle for inverting left joystick
invert_right = False  # Toggle for inverting right joystick
...
def send_joystick_data(dt):
    ...
    if invert_left:
        x_axis_left = -x_axis_left  # Invert left joystick X-axis
        y_axis_left = -y_axis_left  # Invert left joystick Y-axis (if used)
    if invert_right:
        x_axis_right = -x_axis_right  # Invert right joystick X-axis
        y_axis_right = -y_axis_right  # Invert right joystick Y-axis
...
class ControlApp(App):
    def build(self):
        ...
        buttons = [
            ...
            ("Invert Left Joystick", lambda x: toggle_invert_left()),  # New toggle button
            ("Invert Right Joystick", lambda x: toggle_invert_right())  # New toggle button
        ]
