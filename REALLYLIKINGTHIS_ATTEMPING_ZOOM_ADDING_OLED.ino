...
const float acceleration_rate_zoom = 0.2;
const float deceleration_rate_zoom = 0.2;
...
// Homing Parameters
AccelStepper zoomStepper = stepper4;
const int homingSpeed = 500;
const int homingDirection = 1;
const int stallSensitivity = 100;
