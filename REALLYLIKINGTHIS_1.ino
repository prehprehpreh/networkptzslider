...
void sendCurrentMotorPositions() {
    // Send the current positions of all three motors
...
void sendPresetPositions() {
    // Send the positions of preset A and preset B
...
const int tolerance = 1000;  // Tolerance in steps
